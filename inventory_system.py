...
#Custom Libraries
from .defs import CustomErrorBox, getFiles
...
internalfiles = os.path.join(internalfiles, "internal_files/user_packs/inventory")
...
class append_asset(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            asset_directory = os.path.dirname(script_file)+"/internal_files/user_packs/inventory/"+selected_file+"/assets"
            thumbnails_directory = os.path.dirname(script_file)+"/internal_files/user_packs/inventory/"+selected_file+"/thumbnails"
        except:
            selected_file = "important"
            asset_directory = os.path.dirname(script_file)+"/internal_files/"+selected_file+"/assets"

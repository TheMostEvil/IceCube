...
#Custom Libraries
from .defs import CustomErrorBox, isRigSelected, unpack_img, main_face, isOldSkin
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        skin_path = os.path.join(internalfiles,'internal_files/skins/',skin_filename)
...
class reset_skin(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            current_skin = skin_nodes.nodes['Skin Tex'].image
            script_file = os.path.realpath(__file__)
            skin_path = os.path.dirname(script_file)+"/rigs/textures/skin.png"
            #unpacks the skin
            unpack_img(current_skin)
...
class delete_skin(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            script_file = os.path.realpath(__file__)
            skin_path = os.path.dirname(script_file)+"/internal_files/skins/"
            default_skin = os.path.dirname(script_file)+"/rigs/textures/skin.png"
            skin_path = skin_path+"\\"+thumbnail

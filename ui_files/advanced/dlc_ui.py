...
def dlc_assets_UI(self, context, script, layout, inv_system):
    #window setup
    obj = context.scene
    script_file = script
    ...
    try:
        ...
        asset_settings_directory = os.path.dirname(script_file)+"/internal_files/user_packs/inventory/"+asset_selected_file+"/settings.json"
            
            
    except:
        asset_settings_directory = os.path.dirname(script_file)+"/internal_files/important/settings.json"
    
            
    try:
        asset_selected_file = inv_system[context.scene.get("selected_inv_asset")]
        asset_info_directory = os.path.dirname(script_file)+"/internal_files/user_packs/inventory/"+asset_selected_file+"/assets/"+thumbnailnopng+"/info.json"
            
    except:
        asset_info_directory = os.path.dirname(script_file)+"/internal_files/important/info_asset.json"
            
    
            
            
    asset_missing_file_dir_set = os.path.dirname(script_file)+"/internal_files/important/missing_settings.json"
    asset_missing_file_dir_inf = os.path.dirname(script_file)+"/internal_files/important/missing_info.json"
...
def dlc_presets_UI(self, context, script, layout, files_list, rig_baked):
    #window setup
    script_file = script
    ...
    try:
        ...
        settings_directory = os.path.dirname(script_file)+"/internal_files/user_packs/rigs/"+selected_file+"/settings.json"


    except:
        settings_directory = os.path.dirname(script_file)+"/internal_files/important/settings.json"


    try:
        selected_file = files_list[context.scene.get("selected_asset")]
        info_directory = os.path.dirname(script_file)+"/internal_files/user_packs/rigs/"+selected_file+"/rigs/"+thumbnailnopng+"/info.json"

    except:
        info_directory = os.path.dirname(script_file)+"/internal_files/important/info.json"




    missing_file_dir_set = os.path.dirname(script_file)+"/internal_files/important/missing_settings.json"
    missing_file_dir_inf = os.path.dirname(script_file)+"/internal_files/important/missing_info.json"
